	...
	<div class="container">
		<div class="card card-outline rounded-0 card-navy">
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<input type="text" class="form-control form-control-sm rounded-0" readonly reqiured="" name="firstname" id="firstname" value="<?= isset($firstname) ? $firstname : "" ?>">
								</div>
								<div class="form-group">
									<label for="middlename" class="control-label">Middle Name</label>
									<input type="text" class="form-control form-control-sm rounded-0" readonly name="middlename" id="middlename" value="<?= isset($middlename) ? $middlename : "" ?>">
								</div>
								<div class="form-group">
									<label for="lastname" class="control-label">Last Name</label>
									<input type="text" class="form-control form-control-sm rounded-0" readonly reqiured="" name="lastname" id="lastname" value="<?= isset($lastname) ? $lastname : "" ?>">
								</div>
								<div class="form-group">
									<label for="username">Security Key</label>
									<input type="text" name="secret_code" id="secret_code" class="form-control" value="<?= isset($secret_code) ? $secret_code : "" ?>" required readonly  autocomplete="off">
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									<label for="username" class="control-label">Username</label>
									<input type="text" class="form-control form-control-sm rounded-0" readonly reqiured="" name="username" id="username" value="<?= isset($username) ? $username : "" ?>">
								</div>
								<div class="form-group">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-sm btn-primary btn-sm btn-flat" id="submit-button" form="manage-user">Update</button>
			</div>
		</div>
	</div>
</section>
