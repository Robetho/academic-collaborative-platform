...
<nav class="navbar navbar-expand-lg navbar-dark bg-gradient-navy">
            <div class="container px-4 px-lg-5 ">
                ...
                <img src="logo/kiut-logo.png" width="100%" class="d-inline-block align-top" alt="" loading="lazy">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <?php else: ?>
                        <a class="font-weight-bolder text-light pr-3 mx-2 text-decoration-none border-right" href="./login.php">Student Login</a>
